...
# Entity Extraction including pipeline
...
# Function to build annotation template (Empty)
...
def api_keys_exist(env_vars, debug=False):
    ...
    for env in env_vars: # in a folder!
...
for file in os.listdir(resumes_dir):
    ...
    if use_proprietary_llms: # this part ensures that the llm outputs JSON
